...
/// Raises <see cref="KeyDown"/> for every key press with its virtual-key and scan codes.
/// </summary>
internal sealed class KeyboardHook : IDisposable
{
    // The delegate MUST be held in a field: if it is collected, the native callback
    // points at freed memory and the process crashes. (Classic P/Invoke hook pitfall.)
    private readonly LowLevelKeyboardProc _proc;
    private IntPtr _hook;

    /// <summary>(vkCode, scanCode) of the pressed key.</summary>
